...
I was curious if there was a difference in passing levels between the subreddits, just for fun.
...
<div class="chart-set">
  ...
  <div class="chart-stack" style="min-height: 350px;">
    ...
    <div id="subreddit-passing-box-plot" class="chart-layer layer-b"></div>
  </div>
  <script>
    createRatioBarChart("subreddit-passing-ratio", "favorite_subreddit_passing.json", "Passing by Subreddit", undefined, [], ["#333f44", "#2E294E", "#5653FE", "#7D02EB", "#A300D6"], 350);
    createBoxPlot("subreddit-passing-box-plot", "favorite_subreddit_passing_boxplot.json", "Passing by Subreddit", undefined, false, 350);
  </script>
  <div class="toggle">
