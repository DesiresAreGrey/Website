...
I guess theres a lot of pre T trans men on here. Could be due to how getting estrogen is a bit easier (both diy and officially), and also due to how the ftm population skews younger (as we saw earlier).
