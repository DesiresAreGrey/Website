...
<div class="chart-set">
  ...
  <script>
    createColumnChart("leaning-column", "political_leaning_nocis.json", "Political Leaning", "Now", [], undefined, 300);
    createBoxPlot("leaning-box-plot", "political_leaning_nocis_boxplot.json", "Political Leaning", "Now", false, undefined, 300);
  </script>
  <div class="toggle">
