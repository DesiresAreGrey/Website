...
var _a, _Charts_charts;
import "./utils.b8ac3bbf.js";
...
export class Charts {
    ...
    static get charts() {
        return [...__classPrivateFieldGet(_a, _a, "f", _Charts_charts)];
    }
    static createRatioBarChart(chartId, data, title, subtitle, hideSeries, colors, height, normalized = false) {
        ...
        __classPrivateFieldGet(_a, _a, "f", _Charts_charts).push({
            id: chartId,
            title: title,
            subtitle: subtitle,
            type: "ratio-bar",
    ...
    static createBarChart(chartId, data, title, subtitle, hideSeries, colors, height, horizontal) {
        hideSeries.forEach(index => {
            if (data.series[index]) {
                data.series[index].hidden = true;
            }
